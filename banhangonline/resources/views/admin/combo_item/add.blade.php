...
<div class="I-layout flexX">
	<div class="layout_wrapper_02">
		<form class="I-form_input" method="post" action="{{ route('comboitem.store') }}">
			@csrf
					...
					<div class="body_form">
						<div class="input_wrapper">
							...
							<div class="input_form">
								<input type="text" name="comboitem_name" required="">
							</div>
						</div>
						<div class="input_wrapper">
							<div class="input_title flexY">
							...
							<div class="input_form">
								<select name="item_01">
		                			@foreach($items as $value)
										<option value="<?php echo $value->id ?>" >{{ $value->item_name }}</option>
		                			@endforeach
								</select>
							</div>
						</div>
